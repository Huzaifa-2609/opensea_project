    ...
    <>
      ...
      >
        ...
        >
          ...
          <button type="button" class="btn btn-primary btn1 btn-lg fs1 w-50 py-2">
            Explore
          </button>
          <button type="button" class="btn btn-secondary btn1 bd-color bg-color btn-lg fs1 w-50 py-2">
            Create
          </button>
          </div>
        </div>
