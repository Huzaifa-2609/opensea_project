...
const Navbar = (props) => {
  ...
  <button style={{height:"fit-content"}} type="button" className="btn btn-primary btn1 bg-color bd-color">
    <i style={{height:"inherit", width:"inherit"}} className="fas fa-search"></i>
  </button>
</div>
