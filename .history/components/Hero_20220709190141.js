...
const Hero = () => {
  ...
  return (
    <>
      <div className=" d-flex justify-content-between bg align-items-center " style={style}>
        <div className="card mb-3 border-0 bg-transparent" style={{ width: "34rem"}}>
          <div className="card-body">
            ...
            <p className="card-subtitle text-muted mt-3 fs-3 fw-bold" >
            OpenSea is the world's first and largest NFT marketplace
            </p>
          </div>
        </div>
        <div className="card mb-3 border-0 " style={{ width: "34rem"}}>
          <Image src={img} className="card-img-top" alt="..." style={{ height:"34rem"}} />
          {/* <div className="card-body">
