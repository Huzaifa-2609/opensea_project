...
const Vnavbar = (props) => {
    ...
    return (
      <div>
        <nav className="navbar d-flex flex-column shadow-sm fixed-top navbar-expand-lg navbar-light">
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" style={{width:"50%"}} id="navbarSupportedContent">
        ...
        <ul className="navbar-nav d-flex flex-column gap-4 m-auto mb-2 mb-lg-0 fw-bold" style={location.pathname==="/signup"?{visibility:"hidden"}:{}}>
