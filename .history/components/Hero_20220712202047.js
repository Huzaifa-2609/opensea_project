...
const Hero = () => {
  ...
  return (
    ...
    {/* <Vnavbar title={"Cryfts"}/> */}
      <div
        className=" d-flex flex-wrap justify-content-between bg align-items-center "
        style={style}
      >
        <div
          className="card mb-3 border-0 position-absolute bg-transparent"
          style={{ width: "34rem" }}
        >
        ...
        <div className="card mb-3 border-0 position-absolute" style={{ width: "34rem" }}>
          <Image
            src={img}
