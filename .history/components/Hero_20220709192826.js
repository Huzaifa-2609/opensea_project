    ...
    <>
      ...
      >
        ...
        >
          ...
          <button type="button" class="btn btn-primary bd-color bg-color btn1 btn-lg fs1 w-50 py-2  text-muted">
            Explore
          </button>
          <button type="button" class="btn btn-light shadow-sm btn-lg text-color fs1 w-50 py-2 text-muted">
            Create
          </button>
          </div>
        </div>
