        ...
        >
          <div className="card-body">
            ...
            <p className="card-subtitle text-muted mt-3 fs-3">
              {/* Cryfts, is the world's first and largest NFT marketplace */}
              Cryfts is providing you the convinient way of buying and selling NFTs.
            </p>
          </div>
          <div className="d-flex gap-4 m-2">
          <button type="button" class="btn btn-primary bd-color bg-color btn1 btn-lg fs1 w-25 py-2">
            Explore
          </button>
          <button type="button" class="btn btn-light border-1 btn1 shadow-sm btn-lg text-color fs1 w-25 py-2">
            Create
          </button>
          </div>
        </div>
