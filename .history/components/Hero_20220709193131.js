    ...
    <>
      ...
      >
        ...
        >
          ...
          <button type="button" class="btn btn-primary bd-color bg-color btn1 btn-lg fs1 w-25 py-2  fw-bold">
            Explore
          </button>
          <button type="button" class="btn btn-light shadow-sm btn-lg text-color fs1 w-25 py-2 fw-bold">
            Create
          </button>
          </div>
        </div>
