...
const Vnavbar = (props) => {
    ...
    return (
      <div>
        <nav className="navbar  navbar-text h-100 shadow-sm navbar-expand-lg navbar-light">
    <div className=" d-flex flex-column h-100">
      ...
      <div className="collapse navbar-collapse" style={{width:"50%"}} id="navbarSupportedContent">
              ...
              <div className="row height d-flex justify-content-center align-items-center">
                  ...
                  <div className="form">
                    ...
                    <input type="text" className="form-control form-input fs-7" placeholder="Search items, collections and accounts..."/>
                  </div>
      ...
      <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <ul className="navbar-nav gap-4 d-flex flex-column m-auto mb-2 mb-lg-0 fw-bold" style={location.pathname==="/signup"?{visibility:"hidden"}:{}}>
