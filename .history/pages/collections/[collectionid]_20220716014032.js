...
import {CgWebsite} from "react-icons"
  ...
  return (
    ...
    <div className='info-container'>
      ...
      <div className="end-row position-absolute gap-3 mx-3" style={{top:"73%", right:0}} >
        <a style={{"color": "#55acee"}}className="mx-2"  href="#!" role="button">CgWebsite</a>
        <a  className="mx-2" href="#!" role="button"><BsTwitter style={{height:"2rem", width:"2rem"}}/></a>
        <a  className="mx-2" href="#!" role="button"><BsInstagram style={{height:"2rem", width:"2rem"}}/></a>
      <a  className="mx-2" href="#!" role="button"><IoMdMore style={{height:"2rem", width:"2rem"}}/></a>
      </div>
