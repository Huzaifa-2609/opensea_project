...
const Collections = () => {
  ...
  return (
    ...
    <div className='info-container'>
      ...
      <a style={{color: "#3b5998"}} className="mx-2" href="#!" role="button"><i class="fab fa-facebook-f fa-lg "></i></a>
        <a style={{"color": "#55acee"}}className="mx-2"  href="#!" role="button"><i class="fab fa-twitter fa-lg"></i></a>
        <a style={{"color": "#dd4b39"}} className="mx-2" href="#!" role="button"><i class="fab fa-google fa-lg"></i></a>
