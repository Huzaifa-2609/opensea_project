...
const Collections = () => {
  ...
  return (
    ...
    <div className='info-container d-flex justify-content-center container'>
      ...
      <div className="midrow">
        <div className='position-absolute 'style={{top:"73%", right:"auto"}} >
          Created By {" "}
          <span>{collections?.creator}</span>
        </div>
      </div>
