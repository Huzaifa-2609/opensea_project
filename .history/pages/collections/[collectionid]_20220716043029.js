  ...
  return (
    ...
    <div className='info-container d-flex justify-content-between position-relative align-items-center flex-wrap ' style={{marginTop:"27%"}}>
      <div className="mx-4 d-flex flex-column justify-content-center  ">
        ...
        width:"11.25rem", borderRadius:"5px", position:"relative" }}
      ...
      <ul class="list-group list-group-horizontal mt-4 fw-bold fs-4 text-center">
          <li class="list-group-item border-0">
          <span>
              <span className='fw-bolder'>{nfts.length}</span>
          ...
          <span>
              ...
              <div className='text-muted fw-bold'>Owners</div>
            </span>
          </li>
          <li class="list-group-item  border-0">
          <span>
              <span><FaEthereum/>{collections?.floorPrice}</span>
              <div className='text-muted fw-bold'>Floor Price</div>
            </span>
          </li>
          <li class="list-group-item  border-0">
          <span>
              <span><FaEthereum/>{collections?.volumeTraded}</span>
              <div className='text-muted fw-bold'>Floor Price</div>
            </span>
          </li>
