...
const Collections = () => {
  ...
  return (
    ...
    <div className='info-container d-flex justify-content-between position-relative align-items-center flex-wrap ' style={{marginTop:"29%"}}>
      <div className="mx-4 d-flex flex-column justify-content-center  ">
        ...
        />
      <div className="desc my-2 placeholder-glow">
        <div >
          <h2 className={!collections?.title&& "placeholder col-6s"}>{collections?.title}</h2>
        </div>
        <div className=''>
           <b>By</b> {""}
          <span className={`text-primary ${!collections?.title&& "placeholder col-6"}`}>{collections?.creator}</span>
        </div>
        <div className="text-muted mt-3">
          <h6>{collections?.description}</h6>
        </div>
        </div>
      </div>
      ...
      <ul class="list-group list-group-horizontal mt-4 fw-bold fs-5 text-center gap-4">
